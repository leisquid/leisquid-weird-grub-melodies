...
menuentry "Moke DaNashaJia" {
    ## 那沙城塌了便塌
    play 220 220 2 262 1 220 1 0 1 222 1 262 1 220 1 0 1 330 1 311 1 330 1 311 1 330 1 311 1 330 1
}

menuentry "FamilyMart Doorbell" {
    ## bpm=156  g4    d#4   a#3   d#4   f4    a#4   a#3   f4    g4    f4    a#3   d#4
    play 156    784 1 622 1 466 1 622 1 698 1 932 2 466 1 698 1 784 1 698 1 466 1 622 3
}
